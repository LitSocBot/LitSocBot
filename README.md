...
19.```!startcb <choice>```: starts a game with the input number of digits 
20. ```!guesscb <choice>```: returns the number of cows and bulls for the guess
21. ```!stopcb```: ends the game
